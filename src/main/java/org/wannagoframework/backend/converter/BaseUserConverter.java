...
public class BaseUserConverter {
  ...
  public void utilsConverters() {
    orikaBeanMapper.addMapper(BaseUser.class, org.wannagoframework.dto.domain.user.BaseUser.class);
    orikaBeanMapper.addMapper(org.wannagoframework.dto.domain.user.BaseUser.class, BaseUser.class);
  }
}